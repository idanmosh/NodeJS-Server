                                                                        ...
                                                                        <td class="esd-container-frame" width="600" valign="top" align="center">
                                                                            <table width="100%" cellspacing="0" cellpadding="0">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-text">
                                                                                            <p style="font-size: 24px;"><strong>Your group ID Is: " ${groupId} "</strong></p>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
...
const sendGroupId = async (groupId, userEmail) => {
    try {
      nodeoutlook.sendEmail({
        auth: {
          user: "info@kd-ict.com",
          pass: process.env.MAIL_PASS,
        },
        host: "smtp.office365.com",
        port: "587",
        secure: false,
        from: "info@kd-ict.com",
        to: userEmail,
        subject: "PoolOff | Cameras group ID",
        html: createHtmlMsg(groupId),
        text: "",
        replyTo: "",
